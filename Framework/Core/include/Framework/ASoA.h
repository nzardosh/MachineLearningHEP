...
/// NORMAL
#define DECLARE_SOA_INDEX_COLUMN_FULL_DEFINITION(_Name_, _Getter_, _Type_, _Table_, _Suffix_, _label_) \
  struct _Name_##Id : o2::soa::Column<_Type_, _Name_##Id> {                                            \
    ...
    {                                                                                                  \
      return mBinding.get<binding_t>();                                                                \
    }                                                                                                  \
    o2::soa::Binding getCurrentRaw() const                                                             \
    {                                                                                                  \
      return mBinding;                                                                                 \
    }                                                                                                  \
    o2::soa::Binding mBinding;                                                                         \
  };                                                                                                   \
  [[maybe_unused]] static constexpr o2::framework::expressions::BindingNode _Getter_##Id               \
  {                                                                                                    \
    _label_, o2::framework::TypeIdHelpers::uniqueId<_Name_##Id>(),                                     \
      o2::framework::expressions::selectArrowType<_Type_>()                                            \
  }

#define DECLARE_SOA_INDEX_COLUMN_FULL(_Name_, _Getter_, _Type_, _Table_, _Suffix_) \
  DECLARE_SOA_INDEX_COLUMN_FULL_DEFINITION(_Name_, _Getter_, _Type_, _Table_, _Suffix_, "fIndex" #_Table_ _Suffix_)

#define DECLARE_SOA_INDEX_COLUMN_EXPLICIT(_Name_, _Getter_, _Type_, _Table_, _label_) \
  DECLARE_SOA_INDEX_COLUMN_FULL_DEFINITION(_Name_, _Getter_, _Type_, _Table_, "", "fIndex" #_label_)
