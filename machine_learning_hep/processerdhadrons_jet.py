...
class ProcesserDhadrons_jet(Processer): # pylint: disable=invalid-name, too-many-instance-attributes
    ...
    def __init__(self, case, datap, run_param, mcordata, p_maxfiles,
        ...
        self.s_jetsel_gen_unmatched = datap["analysis"][self.typean].get("jetsel_gen_unmatched", None)
    ...
    def process_response_single(self, index): # pylint: disable=too-many-locals
        ...
        df_gen_prompt_unmatched = df_gen_prompt.query(self.s_jetsel_reco)
        df_zvsjetpt_gen_unmatched = df_gen_prompt_unmatched.loc[:, [self.v_varshape_binning, "pt_jet"]]
        ...
        df_zvsjetpt_gen_unmatched = seldf_singlevar(df_zvsjetpt_gen_unmatched, "pt_jet", \
            self.lvar2_binmin_reco[0], self.lvar2_binmax_reco[-1])
        df_zvsjetpt_gen_unmatched = seldf_singlevar(df_zvsjetpt_gen_unmatched, self.v_varshape_binning, \
            self.lvarshape_binmin_reco[0], self.lvarshape_binmax_reco[-1])
